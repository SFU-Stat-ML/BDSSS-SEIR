...
# # For three regimes
# update.pi.1 <- function(y, x,             # y_1:T x_0:T
#                         S, E, I, R,
#                         alpha, m.alpha, sigma.alpha,
#                         beta, m.beta, sigma.beta,
#                         gamma, m.gamma, sigma.gamma,
...
# 
# 
# update.pi.2 <- function(y, x,             # y_1:T x_0:T
#                         S, E, I, R,
#                         alpha, m.alpha, sigma.alpha,
#                         beta, m.beta, sigma.beta,
#                         gamma, m.gamma, sigma.gamma,
...
# 
#       if(log(runif(1)) < log.r){
#         new.pi.k = new.pi.k       # accept move with probably min(1,r)
#         indicator = 1    # indicator of acceptance
#       } else{
#         new.pi.k = pi.k        # otherwise "reject" move, and stay where we are
#         indicator = 0
...
# 
# 
# update.pi.3 <- function(y, x,             # y_1:T x_0:T
#                         S, E, I, R,
#                         alpha, m.alpha, sigma.alpha,
#                         beta, m.beta, sigma.beta,
#                         gamma, m.gamma, sigma.gamma,
