...
pdf(paste("FourRegimeTracePlot.pdf"), width = 10, height = 20)
par(mfrow=c(5,2))
...
plot(parameters.CSMC.AS.repM$f[4, 1:niter], type="l", xlab="Iterations", ylab = expression(f[3]))
...
pdf(paste("FourRegimeHistogram.pdf"), width = 10, height = 20)
par(mfrow=c(5,3))
hist(parameters.CSMC.AS.repM$alpha[1:niter], xlab="", main = expression(alpha))
abline(v=median(parameters.CSMC.AS.repM$alpha[1:niter]), col="red", lwd=2)
hist(parameters.CSMC.AS.repM$beta[1:niter], xlab="",main = expression(beta))
abline(v=median(parameters.CSMC.AS.repM$beta[1:niter]), col="red", lwd=2)
hist(parameters.CSMC.AS.repM$gamma[1:niter], xlab="",main = expression(gamma))
abline(v=median(parameters.CSMC.AS.repM$gamma[1:niter]), col="red", lwd=2)
hist(parameters.CSMC.AS.repM$kappa[1:niter], xlab="",main = expression(kappa))
abline(v=median(parameters.CSMC.AS.repM$kappa[1:niter]), col="red", lwd=2)
hist(parameters.CSMC.AS.repM$lambda[1:niter], xlab="",main = expression(lambda))
abline(v=median(parameters.CSMC.AS.repM$lambda[1:niter]), col="red", lwd=2)
...
abline(v=median(parameters.CSMC.AS.repM$f[2, 1:niter]), col="red", lwd=2)
...
abline(v=median(post.pi.k1[,1]), col="red", lwd=2)
hist(post.pi.k1[,2], xlab="",main = expression(pi[12]))
abline(v=median(post.pi.k1[,2]), col="red", lwd=2)
hist(post.pi.k1[,3], xlab="",main = expression(pi[13]))
abline(v=median(post.pi.k1[,3]), col="red", lwd=2)
hist(post.pi.k2[,1], xlab="",main = expression(pi[21]))
abline(v=median(post.pi.k2[,1]), col="red", lwd=2)
hist(post.pi.k2[,2], xlab="",main = expression(pi[22]))
abline(v=median(post.pi.k2[,2]), col="red", lwd=2)
hist(post.pi.k2[,3], xlab="",main = expression(pi[23]))
abline(v=median(post.pi.k2[,3]), col="red", lwd=2)
hist(post.pi.k3[,1], xlab="",main = expression(pi[31]))
abline(v=median(post.pi.k3[,1]), col="red", lwd=2)
hist(post.pi.k3[,2], xlab="",main = expression(pi[32]))
abline(v=median(post.pi.k3[,2]), col="red", lwd=2)
...
pdf(paste("FourRegimeEstimatedSEIR.pdf"), width = 10, height = 10)
...
# Posterior I_t
pdf(paste(Sys.Date(), "FourRegimeEstimatedIt.pdf"), width = 10, height = 7)
par(mfrow=c(1,1))
...
# Estimated X_t
pdf(paste(Sys.Date(), "FourRegimeEstimatedXt.pdf"), width = 10, height = 7)
par(mfrow=c(2,1))
